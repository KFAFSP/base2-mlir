/// Implements the Bit dialect attributes.
///
/// @file
...
#include "base2-mlir/Dialect/Bit/IR/Attributes.cpp.inc"
...
LogicalResult bit::BitsAttr::verify(
...
void BitDialect::registerAttributes()
{
    addAttributes<
