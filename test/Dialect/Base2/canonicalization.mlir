...
// CHECK-LABEL: func.func @bit_cast_constant(
func.func @bit_cast_constant() -> i32 {
    // CHECK: %[[CST0:.+]] = base2.constant 7 : i32
    // CHECK: return %[[CST0]] : i32
    %0 = base2.constant #base2.bits<"0x00000007"> : si32
    %1 = base2.bit_cast %0 : si32 to i32
    return %1 : i32
}

// CHECK-LABEL: func.func @bit_cast_roundtrip(
// CHECK-SAME: %[[ARG0:.+]]: i64
func.func @bit_cast_roundtrip(%arg0: i64) -> i64 {
    // CHECK: return %[[ARG0]] : i64
    %0 = base2.bit_cast %arg0 : i64 to si64
    %1 = base2.bit_cast %0 : si64 to ui64
    %2 = base2.bit_cast %1 : ui64 to f64
    %3 = base2.bit_cast %2 : f64 to i64
    return %3 : i64
}
...
// CHECK-LABEL: func.func @value_cast_noop(
// CHECK-SAME: %[[ARG0:.+]]: si64
func.func @value_cast_noop(%arg0: si64) -> si64 {
    %0 = base2.value_cast %arg0 : si64 to si64
...
func.func @min_ui_zero(%arg0: ui64) -> (ui64, ui64) {
    // CHECK-DAG: %[[ZERO:.+]] = base2.constant 0 : ui64
    %cst0 = base2.constant 0 : ui64
